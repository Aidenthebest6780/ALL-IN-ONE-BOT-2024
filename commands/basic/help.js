        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const createSlashCommandPages = () => {
                ...
                pages.push({
                    ...
                    image: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                    color: "#3498db",
                    thumbnail: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                    author: {
                        name: 'All In One',
                        iconURL: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                        url: "https://discord.gg/ZJ4tq5hkdD"
                    }
                });
                ...
                for (const [category, commands] of Object.entries(commandData)) {
                    ...
                    switch (category) {
                        case 'anime':
                            page.image = "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif";
                            page.color = "#ff66cc";
                            page.thumbnail = "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif";
                            page.author.iconURL = "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif";
                            break;
                        case 'basic':
                            page.image = "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif";
                            page.color = "#99ccff";
            ...
            const createPrefixCommandPages = () => {
                ...
                pages.push({
                    ...
                    author: {
                        name: 'All In One',
                        iconURL: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                        url: "https://discord.gg/ZJ4tq5hkdDM"
                    }
                });
                ...
                for (const [category, commands] of Object.entries(prefixCommands)) {
                    const page = {
                        ...
                        image: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                        color: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                        thumbnail: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
                        author: {
                            name: `${category.charAt(0).toUpperCase() + category.slice(1)} Commands`,
                            iconURL: "https://share.creavite.co/67675aa80ae0e4f686a62dd3.gif",
